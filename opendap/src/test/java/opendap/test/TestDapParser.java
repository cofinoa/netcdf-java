...
public class TestDapParser extends TestFiles {
  ...
  private Object[] extensionValues() {
    return new Object[] {new Object[] {".das", ".das"}, // Test that the DAS parsing is correct
  ...
  void Test1(String test, String testdir, String resultsdir, String baselinedir, String extension, String baseextension,
    ...
    try (
        InputStream teststream =
            (isfile ? new FileInputStream(testfile) : new URL(testfilepath).openConnection().getInputStream());
